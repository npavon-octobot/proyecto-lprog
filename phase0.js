...
exports.evalProp = function evalProp(prop, value) {
...
exports.truthTable = function truthTable(props, vars) {
  let allCombinations = createVariableCombinations(vars);

  let result = [];
  for (let combination in allCombinations) {
    result.push([allCombinations[combination], exports.evalProp(props, allCombinations[combination])]);
  }
